...
The AIP editors assign AIP numbers and change their status. Please tag all AIP-related proposals to the AIP editor, which is listed under AIP Editors below. Also see AIP Editor Responsibilities & Workflow. The AIP editor reserves the right to reject AIP proposals if they appear too unfocused or too broad.
...
The Created header records the date that the AIP was assigned a number, while Post-History is used to record the dates of when new versions of the AIP are posted to the AssangeDAO forum. Both headers should be in yyyy-mm-dd format, e.g. 2001-08-14.
